...
//  параметр initialValue — довільний рядок,
//   який записується у приватну властивість 
...
//  додає його в кінець значення приватної властивості 
...
// додає його на початок і в кінець значення приватної
