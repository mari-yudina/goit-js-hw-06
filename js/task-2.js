...
//   який записується до створеного об'єкта в приватну властивість
//    items.
...
//  додає його до масиву товарів у приватну властивість
//   items об'єкта.
...
// Візьми код нижче з ініціалізацією екземпляра й
//  викликами методів і встав його після оголошення
//   класу для перевірки коректності роботи.
